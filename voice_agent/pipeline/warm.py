...
def piper():
    ...
    factory.PIPER_DIR.mkdir(parents=True, exist_ok=True)
    if not (factory.PIPER_DIR / f"{CONFIG.tts_voice_piper}.onnx").exists():
        download_voice(CONFIG.tts_voice_piper, factory.PIPER_DIR)
